...
public class MuCharacterBase {
    ...
    protected int calculateHP (int lvl, int vit) {
		...
		{
			case 0x00: 
			case 0x10: rlive= 60+(lvl*1)+(vit*1);break;
			case 0x20: 
			case 0x30: rlive=110+(lvl*2)+(vit*3);break;
			case 0x40: 
			case 0x50: rlive= 80+(lvl*1)+(vit*1);
			case 0x60: rlive= 110+lvl+(vit*2);break;
			case (byte) 0x80: rlive= 110+lvl+(vit*2);break;
			default:rlive=0;break;
		}
		return rlive;
	}
    ...
    protected int calculateMP (int lvl, int enr) {
		int rmp=0;
			...
			{
				case 0x00: 
				case 0x10: rmp=60+(lvl*2)+(enr*2);break;
				case 0x20: 
				case 0x30: rmp= (int)(20+(lvl*0.5)+(enr*1));break;
				case 0x40: 
				case 0x50: rmp= (int)(30+(lvl*1.5)+(enr*1.5));break;
				case 0x60: rmp= 60+(lvl*1)+(enr*2);break;
				case (byte) 0x80: rmp= 60+(lvl*1)+(enr*2);break;	
			};
			return rmp;
	}
