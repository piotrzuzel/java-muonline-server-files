 ...
 * @author Miki i Linka
 * @TODO Write going steps depends time using to got the last one wsp and also change moving quene when player change path request in half way
 */
public class MuMove {
