...
/**
 * 
 * @author kinasiewicz10168342
 * MuViewPoint
 * The data structure to hold distance between two objects, State of view and type 
 */
public class MuViewPoint {
	...
	public String toString() {
		String t = String.format("Obj[Index:%d,Type%d] in distance [%f],State:[", o_Index,o_Type,o_Dist);
		t+=c_State+"]";
		return t;
	}
