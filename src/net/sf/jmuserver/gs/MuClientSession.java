...
/**
 * This class represent all data priate to client sesion:
 * @author Mikione
 */
public class MuClientSession implements MuSessionStatus{

	/**
	 * each object or connection session have unique ID
	 */
	private int sesionID;
	
	/**
	 * Sesion can be in deferent stages:
	 * STAGE_AUTCHORYSING  
	 * STAGE_CHARACTER_CHOSING
	 * STAGE_INGAME
	 */
	private byte sesionStage=MuSessionStatus.STAGE_AUTCHORIING; 
	 ...
	 */
	public MuClientSession(int _sesionID)
	{
		sesionID = _sesionID;
		sesionStage = MuSessionStatus.STAGE_AUTCHORIING;
	}
