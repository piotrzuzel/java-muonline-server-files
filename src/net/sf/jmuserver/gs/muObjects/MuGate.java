 ...
 */
public class MuGate {
public static final int FlagNoGate =0x00; //to telepowrt without enter to gate
...
private int _lvlRequared;
    ...
    public MuGate(int _gateNb, int _flag, int _Map, int _x1, int _y1, int _x2, int _y2, int _toGate, int _HeadDir, int _lvlRequared) {
